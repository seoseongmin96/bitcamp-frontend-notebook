...
export default function Calc (){
    ...
    <button onClick={() =>{setNum1(document.getElementById('num1').value)}}>숫자 1 결정 </button>
    <button onClick={() =>{setNum2(document.getElementById('num2').value)}}>숫자 2 결정 </button>
    <button onClick={() =>{sum()}}>더하기 실행</button>
    <div>결과: {num1} + {num2} = {result}
    </div>
   </div>
    </Layout>
}
